...
export default function OrdersClient({ orders }: Props) {
    ...
    if (orders.length === 0) {
        return (
            <PageContainer className="p-0! -my-6 flex flex-col items-center justify-center text-center min-h-[calc(100vh-64px)] space-y-6">
                <div className="p-4 bg-gray-100 rounded-lg">
                    <LuPackage size={30} className="text-gray-400" />
                </div>

                <div className="text-gray-500 space-y-1">
                    <h1 className="mb-1 text-lg font-medium">No orders yet</h1>
                    <p className="text-sm">
